...
public class Terra_Voyager extends Adventurer {
    public Terra_Voyager(int health, int dodge_chance, String affinity, String discord, ArrayList<Integer> current_room, int treasure, int dice_roll_combat_delta, int dice_roll_treasure_delta) {
